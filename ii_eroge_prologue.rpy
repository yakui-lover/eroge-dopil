...
label ii_eroge_prologue:
    ...
    "Не то чтобы я верил в сказки...{w} Я просто собирался поесть в Макдональдсе, который находится совсем не там, как требует легенда, и совсем не в то время."
    window hide
    ...
    window show
    "Он поехал дальше, словно водитель забыл о своём единственном пассажире. Автобус шёл на разгон, набирая скорость."

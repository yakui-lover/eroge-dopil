...
label prologue:
    ...
    window show
    "Как мало мои слова значат даже во сне..."
    ...
    window show
    "Зачастую они резко меняли свое мнение, противореча своим убеждением. Иногда и я грешил тем же.{w} Но мы были одним." 
    ...
    window show
    "На остановке никого не было. Я нырнул под навес, прячась от ледяного ветра, пронизывавшего дешёвое пальто."
    ...
    "Стану умным. Красивым. Встречу умницу-красавицу, которая полюбит меня с первого взгляда. Я для неё, она для меня."
